...
export default function DashboardOverview() {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10">
      {/* Gradient hero */}
      <div className="relative mb-8 overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-purple-600/15 via-pink-500/10 to-cyan-500/15 p-6">
        <div className="absolute -top-16 -left-16 h-48 w-48 rounded-full bg-purple-500/20 blur-3xl" />
        ...
        <div className="mt-4 flex items-center justify-center gap-4">
          <Link
            ...
            className="rounded-2xl px-6 py-3 font-semibold text-sm text-white shadow-lg border border-purple-400/30 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 transform hover:scale-[1.02] transition-all duration-200"
          >
            📺 Subscriptions
          </Link>
          <Link
            href="/dashboard/orders"
            className="rounded-2xl px-6 py-3 font-semibold text-sm text-white shadow-lg border border-cyan-400/30 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 transform hover:scale-[1.02] transition-all duration-200"
          >
            📦 Orders
          </Link>
          <Link
            href="/dashboard/expenses"
            className="rounded-2xl px-6 py-3 font-semibold text-sm text-white shadow-lg border border-green-400/30 bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 transform hover:scale-[1.02] transition-all duration-200"
          >
            💰 Expenses
          </Link>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
          ...
          <div className="space-y-3">
            ...
            {potentialSavings > 0 && (
              <div className="flex items-center justify-between rounded-xl bg-green-500/10 p-3">
